...
const NextJSIcon = (props: SvgIconProps) => (
    <SvgIcon {...props} htmlColor='white'>
        <path d="M18.665 21.978C16.758 23.255 14.465 24 12 24 5.377 24 0 18.623 0 12S5.377 0 12 0s12 5.377 12 12c0 3.583-1.574 6.801-4.067 9.001L9.219 7.2H7.2v9.596h1.615V9.251l9.85 12.727Zm-3.332-8.533 1.6 2.061V7.2h-1.6v6.245Z" />
    </SvgIcon>
);

const GraphQLIcon = (props: SvgIconProps) => (
    <SvgIcon {...props} htmlColor='#E10098'>
...
const GoIcon = (props: SvgIconProps) => (
    <SvgIcon {...props} htmlColor='#00ADD8'>
...
export default function Footer() {
    return (
        <footer className="flex flex-row items-center justify-evenly p-8 bg-gray-900 mt-auto">
            <div className="text-center">
                <span className="text-gray-200">Made with <Favorite color='error' /> by </span>
                <Link href="https://www.linkedin.com/in/azanul-haque" className="text-blue-500 hover:underline">
                    Azanul
                </Link>
            </div>
            <Link href="https://github.com/Azanul/Next-Watch" passHref className="text-blue-500 hover:underline justify-evenly">
                <GitHub fontSize="large" /> Repo
            </Link>
            <div className="flex items-center space-x-4">
                <span className="text-gray-200">Powered by</span>
                <Link href="https://nextjs.org/" className="text-blue-500 hover:underline">
                    <NextJSIcon />
                </Link>
                <Link href="https://graphql.org/" passHref className="text-blue-500 hover:underline">
                    <GraphQLIcon />
                </Link>
                <Link href="https://golang.org/" passHref className="text-blue-500 hover:underline">
                    <GoIcon />
                </Link>
            </div>
        </footer>
